...
datapath = 'Coherent_data_526';
if ~exist(datapath,'dir')
    mkdir(datapath);
end

% prefix = '20250520_QPSK_32GBaud_80GSa_O_B2B';
% sT = 50;
% for idx = 1:50
...
% ch = rcosdesign(0.01, 8, 2);
% mf_sig = filter(ch, 1, cdc_sig);
mf_sig = filter(1, 1, rx);
% scatterplot(cdc_sig);
...
% [bps_out, estimatedPhase] = BPS(fse_out(1:2^17), constellation, 4, 2);
